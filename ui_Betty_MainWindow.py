...
# Form implementation generated from reading ui file 'C:\Users\Mike_2\Eclipse workspace\Betty\src\Betty_MainWindow.ui'
#
...
class Ui_Betty_MainWindow(object):
    def setupUi(self, Betty_MainWindow):
        ...
        self.raceTable = QtGui.QTableWidget(self.centralwidget)
        self.raceTable.setAcceptDrops(False)
        self.raceTable.setAutoFillBackground(True)
        self.raceTable.setEditTriggers(QtGui.QAbstractItemView.DoubleClicked|QtGui.QAbstractItemView.EditKeyPressed)
        self.raceTable.setDragDropMode(QtGui.QAbstractItemView.NoDragDrop)
        self.raceTable.setAlternatingRowColors(True)
        self.raceTable.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.raceTable.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        self.raceTable.setShowGrid(False)
        self.raceTable.setGridStyle(QtCore.Qt.NoPen)
        self.raceTable.setObjectName("raceTable")
        self.raceTable.setColumnCount(0)
        self.raceTable.setRowCount(0)
    ...
    def retranslateUi(self, Betty_MainWindow):
        ...
        self.editButton.setText(QtGui.QApplication.translate("Betty_MainWindow", "Edit", None, QtGui.QApplication.UnicodeUTF8))
